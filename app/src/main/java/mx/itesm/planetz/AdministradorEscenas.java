...
public class AdministradorEscenas
{
    ...
    private EscenaBase escenaNivelUno;
    ...
    //*** Crea la escena de Jugar
    public void crearEscenaJugar() {
        // Carga los recursos
        escenaNivelUno = new EscenaNivelUnoPrueba();
    }

    //*** Libera la escena de Jugar
    public void liberarEscenaJugar() {
        escenaNivelUno.liberarEscena();
        escenaNivelUno = null;
    }
/*
